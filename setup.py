...
URL = "https://github.com/andlo/ovos-skill-ovosblog"
SKILL_CLAZZ = "OVOSBlog"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-ovosblog"  # pip install PYPI_NAME
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="Reads the OpenVoiceOS blog aloud - provider skill for ovos-skill-common-reading",
    ...
    keywords="ovos skill voice assistant blog rss news openvoiceos",
